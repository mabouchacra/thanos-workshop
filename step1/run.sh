...
startCompose(){
  ...
  echo -e "\n\n${GREEN}Prometheus for DC1 should be availaible at http://localhost:9091${NOCOLOR}"
  echo -e "\n\n${GREEN}Prometheus for DC2 should be availaible at http://localhost:9092${NOCOLOR}"
